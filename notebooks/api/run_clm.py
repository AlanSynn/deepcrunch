...
class ModelArguments:
    ...
    accuracy: bool = field(default=False, metadata={"help": "get accuracy"})
...
def main():
    ...
    if model_args.tune:
        ...
        accuracy_criterion = AccuracyCriterion(
            higher_is_better=False, tolerable_loss=0.5
        )
    ...
    if model_args.performance or model_args.accuracy:
        ...
        if model_args.performance:
            ...
            b_conf = BenchmarkConfig(
                warmup=5, iteration=100, cores_per_instance=4, num_of_instance=1
            )
